...
Here is the [link](FinalQ1.html) to this 
...
Here is the [link](FinalQ2.Rmd)
ggplot was not working properly so I had to change it to plot_ly
...
This is the [link](FinalQ3.Rmd) to my dashboard
I got an error that "subscript out of bounds"
...
Include the link of your dashboard [here](https://ajohnson32.shinyapps.io/FinalQ4/).
#had an issue using ggplot so I used plot_ly instead
...
Include the link of your dashboard [here](https://ajohnson32.shinyapps.io/FinalQ5/).
I had the same issue with ggplot as before
...
Include the link of your dashboard [here](https://ajohnson32.shinyapps.io/FinalQ6/).
I had the same issue with ggplot as before
...
Include the link of your dashboard [here](https://ajohnson33.shinyapps.io/FinalQ7/).
Same issue with ggplot as before
...
Include the link of your dashboard [here](https://ajohnson33.shinyapps.io/FinalQ8/).
...
Include the link of your dashboard [here](https://ajohnson33.shinyapps.io/FinalQ9/).
...
Include the link of your dashboard [here](https://ajohnson33.shinyapps.io/FinalQ10/).
